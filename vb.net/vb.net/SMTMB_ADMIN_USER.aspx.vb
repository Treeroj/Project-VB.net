...
Partial Class SMTMB_ADMIN_USER
...
"(:sADMINCHANGE,:sDAY,:sTIME,:sUSERID,:sUSERNAME,:sPROCESS,:sPRODUCTS,:sKEYHIS,:sSTATUT)"
            ...
            objCmdchk.Parameters.Add("@sPROCESS", "SMT")
    ...
    Private Sub Load_gvHIS()
        Dim conn As New OracleConnection(MT800DB)
        Dim cmd As New OracleCommand()
        Dim acc As String = "SELECT ADMINCHANGE,DAY,TIME,USERID,USERNAME,PROCESS,PRODUCTS,KEYHIS,STATUT FROM NVP_ALLPROCESS_LOG_CHANGEUSER"
