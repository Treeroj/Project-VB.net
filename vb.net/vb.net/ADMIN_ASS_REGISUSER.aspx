<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ADMIN_ASS_REGISUSER.aspx.vb" Inherits="ADMIN_ASS_REGISUSER" %>
...
<header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <main id="main" class="main">
            <div class="pagetitle">
                <h1>Material Record for Assembly Admin Change Material</h1>
                <nav>
                    <ol class="breadcrumb">
