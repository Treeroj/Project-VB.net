<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Chemical_ASS.aspx.vb" Inherits="Chemical_ASS" %>
...
<body>
    ...
    <img src="image/fluid-loader.gif" alt="กำลังโหลดข้อมูล"/>
        ...
        <main id="main" class="main">
            <div class="pagetitle">
                <h1>Chemical System</h1>
                <nav>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="http://172.16.72.179/MT800PST-ALLPRODUCT/">MT800</a></li>
                        <li class="breadcrumb-item">Chemical System</li>
                        <li class="breadcrumb-item active">Chemical for Assembly</li>
                    </ol>
                </nav>
            </div>
                ...
                <div class="row">
                            ...
                            <div class="card-body">
                                ...
                                <asp:UpdatePanel ID="UpdatePanel6" runat="server" UpdateMode="Conditional">
                                    ...
                                    <ContentTemplate>
                                        ...
                                        <asp:Panel ID="PNddlLine" runat="server" Visible="false">
                                        ...
                                        <asp:Panel ID="PNlbshow" runat="server" Visible="false">
                                            </br>
                    ...
                    <div class="col-lg-4">
                        <asp:UpdatePanel ID="UpdatePanel5" runat="server" UpdateMode="Conditional">
                            ...
                            <ContentTemplate>
                                <asp:Panel ID="PaneChemicalCheck1" runat="server" Visible="false">
                                    <div class="card">
                                        <div class="card-body">
                                            </br>
                                           <div class="text-center">
                                               <h3 class="card-title">Chemical Check</h3>
                                           </div>
                                            <div class="card-text">เคมี / Chemical :</div>
                                            <asp:Panel ID="Panel2" runat="server">
                                                <label class="custom-field three" style="width: 100%">
                                                    <asp:TextBox ID="tnMaterial" runat="server" autocomplete="off" ForeColor="black" Visible="true" OnTextChanged="tnMaterial_TextChanged"
                                                        Width="100%" class="form-control" placeholder="กรุณายิงบาร์โค้ด Chemical" onblur="if(this.value.trim() !== '') {__doPostBack('','');}" />
                                                </label>
                                                </br>
                                                </br>
                                                <ul class="nav navbar-nav navbar-right navbar-expand-lg navbar-expand-xs navbar-expand-md navbar-expand">
                                         ...
                                         <asp:Panel ID="PNBUT" runat="server" Class="text-center">
                    ...
                    <div class="col-lg-4">
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                            ...
                            <ContentTemplate>
                                <asp:Panel ID="PaneChemicalCheck2" runat="server" Visible="false">
                                    <div class="card">
                                        <div class="card-body">
                                            </br>
                                            <asp:GridView ID="GridViewModel" runat="server" AutoGenerateColumns="false"
                                    ...
                                    <asp:Panel ID="PaneChemicalCheck3" runat="server" Visible="false">
                                    <div class="card">
                    ...
                    <div class="col-lg-12">
                        <asp:UpdatePanel ID="UpdatePanel3" runat="server" UpdateMode="Conditional">
                            ...
                            <ContentTemplate>
                                <asp:Panel ID="PanelChemicalHIS" runat="server" Visible="false">
                                    <div class="card">
                                        <div class="card-body">
                                           <div class="text-center">
                                        <h3 class="card-title">Chemical HIS</h3>                                  
                                        </div>
<div class="card-text">เคมี / Chemical :</div>
